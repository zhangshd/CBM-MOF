...
#   sbatch --array=0-2 src/alignn/run_extract_embeddings.sh
#
#   # Single split (e.g. test only):
#   sbatch --array=2 src/alignn/run_extract_embeddings.sh
# ============================================================
...
OUTPUT_DIR="$REPO/results/alignn/ep100_deployment"
