...
run_breakthrough.py
===================
Task 3.2: Batch breakthrough simulation for Top-10 PSA + Top-10 VSA + benchmark.
...
Usage:
    python src/alignn/run_breakthrough.py
    python src/alignn/run_breakthrough.py --model-dir results/alignn/model_ep150
    python src/alignn/run_breakthrough.py --dry-run
    python src/alignn/run_breakthrough.py --rebuild-curve-cache
"""
