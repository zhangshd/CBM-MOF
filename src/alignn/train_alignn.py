...
Targets (8 total):
  Per-column symlog: AdsCH4_10kPa (τ=1e-6), AdsCH4_100kPa (τ=1e-6),
                     AdsCH4_1000kPa (τ=0.177), AdsN2_10kPa (τ=1e-6),
                     AdsN2_100kPa (τ=0.013)
  Raw (no transform): AdsN2_1000kPa, QstCH4, QstN2

  Config serialized to: data/alignn/transform_config.json
...
Usage:
    ...
    # Full training
    CUDA_VISIBLE_DEVICES=0 python train_alignn.py
"""
