...
psa_data = {
    "m18_o16_o109":            {"igd": 7,  "api": 1},   # API 0.629
    "YOBPOW":                  {"igd": 1,  "api": 2},   # API 0.614
    "m3_o18_o80":              {"igd": 8,  "api": 3},   # API 0.605
    "m3_o1480_o156.14":        {"igd": 5,  "api": 4},   # API 0.557
    "m3_o25_o460.15":          {"igd": 6,  "api": 5},   # API 0.557
    "2009[Cd][nuc]3[ASR]1":    {"igd": 2,  "api": 6},   # API 0.505
    "m3_o10_o146":             {"igd": 9,  "api": 7},   # API 0.504
    "TAKTOR":                  {"igd": 4,  "api": 8},   # API 0.487
    "2013[Mg][dia]3[ASR]1":    {"igd": 10, "api": 9},   # API 0.458
    "ATC-Cu":                  {"igd": 3,  "api": 10},  # API 0.457
}

# VSA Top-10: API re-ranked within these 10 materials
vsa_data = {
    "2011[Ni][dia]3[ASR]1":    {"igd": 7,  "api": 1},   # API 0.556
    "m3_o47_o15.8":            {"igd": 10, "api": 2},   # API 0.439
    "m3_o14_o80":              {"igd": 5,  "api": 3},   # API 0.405
    "m3_o1490_o15.17":           {"igd": 8,  "api": 4},   # API 0.368
    "m3_o16_o460.20":          {"igd": 4,  "api": 5},   # API 0.351
    "m3_o1490_o15.16":         {"igd": 9,  "api": 6},   # API 0.300
    "2021[Ni][dia]3[ASR]1":    {"igd": 3,  "api": 7},   # API 0.294
    "QAJDEK":                  {"igd": 6,  "api": 8},   # API 0.270
    "2010[Co][pts]3[ASR]2":    {"igd": 1,  "api": 9},   # API 0.211
...
# ── Drawing one panel ───────────────────────────────────────────────────────
LABEL_FS = 10   # Material name font size (≥ TICK_FONT_SIZE + 2)
...
def draw_bump_panel(
    ...
    xtick_labels[1].set_ha("left")
    xtick_labels[1].set_multialignment("left")
